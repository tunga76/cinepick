...
Movie-detail showtime failures offer a retry that reloads only showtimes, preserving
the loaded movie. Loading, failure and empty results are distinct accessible states;
repeated retry clicks cannot start concurrent requests.
